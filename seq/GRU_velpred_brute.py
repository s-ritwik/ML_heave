...
def parse_config_line(config_line):
    ...
    for param in params:
        ...
        elif key in ['sequence_length', 'output_size', 'x_seconds', 'batch_size', 'epochs', 'step_size', 'T_max', 'tail_obs', 'cont_warmup_epochs']:
            config[key] = int(value)
        elif key in ['learning_rate', 'decay', 'gamma', 'w', 'jump_w', 'vel_w', 'acc_w']:
